...
public class OrdenListaAdapter extends BaseAdapter {

    private LayoutInflater inflater;
    private String[] sortBy;
    private int selectedId;

    public OrdenListaAdapter(Context context, String[] sortBy, int selectedId) {
        this.sortBy = sortBy;
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        rowView = inflater.inflate(R.layout.orden_productos_listitem, null);
